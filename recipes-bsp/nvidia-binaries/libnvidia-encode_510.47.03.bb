...
RDEPENDS:${PN} = "libnvidia-decode"

#
#usr/
#usr/lib/
#usr/lib/x86_64-linux-gnu/
#usr/lib/x86_64-linux-gnu/libnvidia-encode.so.510.47.03
#usr/lib/x86_64-linux-gnu/libnvidia-encode.so -> libnvidia-encode.so.1
#usr/lib/x86_64-linux-gnu/libnvidia-encode.so.1 -> libnvidia-encode.so.510.47.03
